...
ENCODER_DROPOUT = 0.2      # Lighter dropout in encoder
...
FOCAL_GAMMA = 3.5   # Focusing parameter (standard) default = 2.0
FOCAL_ALPHA = 0.15 # Class balancing weight default = 0.25
